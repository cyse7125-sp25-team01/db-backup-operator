...
import (
	...
	"csye7125-team01.store/backup-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "789a49e0.csye7125-team01.store",
	...
	if err = (&controller.BackupDatabaseSchemaReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BackupDatabaseSchema")
		os.Exit(1)
	}
